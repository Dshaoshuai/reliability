...
# -- Basic --
parser.add_argument('--job_folder',type=str,default='C:/Users/25714/PycharmProjects/reliability/job_dags/',help='job folder path \
...
parser.add_argument('--num_stream_jobs',type=int,default=50,help='number of streaming jobs (default: 50)')
...
parser.add_argument('--num_mods',type=int,default=30,help='the number of modules (default: 30)')   #不包含entry module和exit module
...
# -- exe environment --
parser.add_argument('--num_edge_clouds',type=int,default=10,help='Number of total edge clouds (default: 10)')
parser.add_argument('--num_processors',type=int,default=37,help='number of total processors')
parser.add_argument('--lis_dist_ec_grade',type=int,default=[0,50,200,500],nargs='+',help='the\
                       distance list between mobile device and each edge clouds from near to far')
parser.add_argument('--dic_num_ec_grade',type=int,default={0:1,50:3,200:5,500:1},help='the number dic of ecs in each distance grade')
parser.add_argument('--dic_class_edge_clouds',type=int,default={'A':6,'B':3,'C':1},help='the dic of each ec type and its number of processors')
parser.add_argument('--dic_num_ec_class_total',type=int,default={'A':3,'B':6,'C':1},help='the dic of each type of ec and its total number')
parser.add_argument('--dic_num_ec_class_grade',type=int,default={0:{'A':0,'B':0,'C':1},50:{'A':1,'B':2,'C':0},200:{'A':1,'B':4,'C':0},500:{'A':1,'B':0,'C':0}},help=\
